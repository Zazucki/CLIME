...
class WindowThread(threading.Thread):
    ...
    def run(self):
        ...
        t.lift()
        instruction = tk.Text(t, bg="#0C0C0C", fg="#CCCCCC", font=("Consolas", 11))
        instruction.pack()
...
LQuiz3 = Quiz([
    ...
    Question("Which option updates the files in the zip archive?", ["-u"], ["-z", "-x", "-u", "-r"]),
    Question("What are the 3 permissions for a file?", ["Read , Write, and Execute."], ["Read , Write, and Execute.", "Write, Execute, and Run", "Run, Read, and Execute", "Read, Write, and Run"]),
