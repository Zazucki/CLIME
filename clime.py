...
LL1E8 = Question("Print out your kernel version",
                ...
                levelNumber=1,
                exerciseNumber=8)
LL1E9 = Question("Enter the digits to give read, write, and excute permissions to the file clime.py",
                ["chmod 755 clime.py"],
                output="\nSUCCESSFULLY COMPLETED",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=9)
LL1E10 = Question("Which option to sudo outputs the version?",
                ["sudo -V"],
...
LL2E1 = Question("Does mv work silently, True or False?",
                ...
                levelNumber=2,
                exerciseNumber=1)
LL2E2 = Question("Move your temp.py file from one directory to Desktop.",
...
LL2E3 = Question("Remove the temp.py file from your documents folder.",
                ...
                levelNumber=2,
                exerciseNumber=3)
LL2E4 = Question("Try to remove the REMOVE directory from your terminal.",
                ["rmdir REMOVE"],
                output="\nSUCCESSFULLY COMPLETED",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
...
LL2E8 = Question("Is the rmdir command silent?",
                ...
                levelNumber=2,
                exerciseNumber=8)
LL2E9 = Question("Enter the command to ouput a list of all ip addresses associated on the network",
                ["ip a "],
                ...
                levelNumber=2,
                exerciseNumber=9)
LL2E10 = Question("Etner the command to display all network interfaces.",
                ["ip link show"],
...
LL3E1 = Question("Enter the command that will output the contained content of imageFile.tar?",
                ...
                levelNumber=3,
                exerciseNumber=1)
LL3E2 = Question("Verify an archive file named iamatarfile.tar.",
...
LL3E7 = Question("Enter the syntax to back up an entire harddisk (HINT: review difference between backing up and cloning).",
                ...
                output="\n BACKUP OF HARDDISK HAS STARTED.",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=3,
                exerciseNumber=7)
...
WL1E1 = Question("Does syntax matter in the command line?",
                ["yes", "Yes"],
                output="",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="W",
                levelNumber=1,
                exerciseNumber=1)
WL1E2 = Question("Are options case-sensitive",
                ["yes", "Yes"],
                output=" ",
                feedback=lambda their_answer,correct: feedback2(their_answer, correct),
                platform="W",
                levelNumber=1,
                exerciseNumber=2)
WL1E3 = Question("Print out the command used to show the available directories",
                ["dir"],
                ...
                levelNumber=1,
                exerciseNumber=3)
WL1E4 = Question("Change your working directory to be in the Desktop folder",
                ...
                levelNumber=1,
                exerciseNumber=4)
WL1E5 = Question("From the Desktop folder, change you directory to the Documents folder (hint: you may have to type out the folder path starting with C:/",
                ...
                levelNumber=1,
                exerciseNumber=5)
WL1E6 = Question("What option would you enter if you wanted to know what options are available for the DIR command?",
                ["/?", "dir /?", "DIR /?, Dir /?"],
                ...
                levelNumber=1,
                exerciseNumber=6)
WL1E7 = Question("Write the command that prints out the directory structure graphically",
                ["tree", "test answer 2"],
                ...
                levelNumber=1,
                exerciseNumber=7)
WL1E8 = Question("Write the command that prints out the directory structure and all its containing files graphically",
                ["tree /F"],
...
WL2E1 = Question("Let's assume we're working in the Documents folder. Create a new directory named Alpha in the current working directory.",
                ...
                levelNumber=2,
                exerciseNumber=1)
WL2E2 = Question("In the same Documents folder, in one command create a new directory named 'foo' with another folder named 'bar' in it.",
...
WL2E3 = Question("Remove the recently created Alpha directory and all of it's contents without asking to confirm your action.",
                ...
                levelNumber=2,
                exerciseNumber=3)
WL2E4 = Question("create a 10KB text file (.txt) with the name reportCard.",
                ...
                levelNumber=2,
                exerciseNumber=4)
WL2E5 = Question("Move that file you just created to the Documents folder. (Assume you are in the CLIME folder",
                ...
                levelNumber=2,
                exerciseNumber=5)
WL2E6 = Question("Given the following directly, show the contents of gradesSpring.txt.\n\nC:.\n│   dash.props\n│   gradesSpring.txt\n│   lab3.txt\n│   lab7.txt\n│   reportCard.txt\n│\n└───foo\n    └───bar",
                ...
                levelNumber=2,
                exerciseNumber=6)
WL2E7 = Question("Show the contents of the reportCard file.\n\nC:.\n│   dash.props\n│   gradesSpring.txt\n│   lab3.txt\n│   lab7.txt\n│   reportCard.txt\n│\n└───foo\n    └───bar\n",
                ...
                levelNumber=2,
                exerciseNumber=7)
WL2E8 = Question("move the lab7.txt file to the 'foo' folder.\n\nC:.\n│   dash.props\n│   gradesSpring.txt\n│   lab7.txt\n│   reportCard.txt\n│\n└───foo\n    └───bar",
                ["move lab7.txt foo"],
                output="C:.\n│   dash.props\n│   gradesSpring.txt\n│   reportCard.txt\n│\n└───foo\n    │   lab7.txt\n    │\n    └───bar\n",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="W",
...
WQuiz1 = Quiz([
    Question("Options are case sensetive",
            ...
            ["True", "False"],
            ask_until_correct=False),
    Question("The commands cd and chdir accomplish the same thing",
            ["True"],
            ["True", "False"],
            ask_until_correct=False),
    Question("dir command allows you to change the directory you're in",
            ["False"],
            ["True", "False"],
            ask_until_correct=False),
...
WQuiz2 = Quiz([
    Question("mkdir foo bar makes:",
            ...
            ask_until_correct=False),
    Question("rmdir is used to remove an existing directory.",
            ["True"],
            ["True", "False"],
            ask_until_correct=False),
    Question("rmdir \"foo bar\" ",
    ...
    Question("If you need to overwrite a file when moving a directory, what parameter do you specify in the command?",
            ...
            ["/Yes", "'OVERWRITE'", "/Y", "/S"],
            ask_until_correct=False),
    Question("What utility is used to create a new file",
            ["fsutil file createNew"],
            ["file create new", "create new file", "fsutil create newFile", "fsutil file createNew"],
            ask_until_correct=False),
    Question("What command shows your the contents of a file in the command line",
            ["more"],
            ["/?", "more", "move", "show"],
            ask_until_correct=False),
    Question("the numerical attribute used when making a new file is measured in Megabytes",
            ["False"],
            ["True", "False"],
            ask_until_correct=False),
    Question("What command moves the arizona.txt file to the Documents folder?",
            ...
            ask_until_correct=False),
    Question("more C:\\Users\\CLIME\\Pictures\\lineup.txt",
...
WQuiz3 = Quiz([
    Question("ipconfig /all shows you detailed information about all network interfaces",
            ["True"],
            ["True", "False"],
            ask_until_correct=False),
    Question("",
