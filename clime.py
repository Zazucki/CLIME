...
WL3E2 = Question("EX2. Type the command to see if 8.8.8.8 is reachable",
                ...
                levelNumber=3,
                exerciseNumber=2)
WL3E3 = Question("EX3. Type the command that will get rid of the IPv4 address of the default network adapter\n\nWireless LAN adapter Wi-Fi:\n\n   Connection-specific DNS Suffix  . : Work\n   Description . . . . . . . . . . . : CLIME XQ 763xxA Wireless Network Adapter\n   Physical Address. . . . . . . . . : F0-1D-AC-8D-12-90\n   DHCP Enabled. . . . . . . . . . . : Yes\n   Autoconfiguration Enabled . . . . : Yes\n   Link-local IPv6 Address . . . . . : fe80::839:3d83:be2e:eb99%21(Preferred)\n   IPv4 Address. . . . . . . . . . . : 192.168.0.83(Preferred)\n   Subnet Mask . . . . . . . . . . . : 255.255.255.0\n   Lease Obtained. . . . . . . . . . : Monday, March 30, 2020 11:26:36 AM\n   Lease Expires . . . . . . . . . . : Wednesday, April 1, 2020 11:27:18 AM\n   Default Gateway . . . . . . . . . : 192.168.0.1\n   DHCP Server . . . . . . . . . . . : 192.168.0.1\n   DHCPv6 IAID . . . . . . . . . . . : 115379648\n   DHCPv6 Client DUID. . . . . . . . : 00-01-00-01-26-22-B8-71-F0-1D-BC-8D-02-90\n   DNS Servers . . . . . . . . . . . : 1.1.1.2\n                                       1.1.1.1\n   NetBIOS over Tcpip. . . . . . . . : Enabled\n",
                ["ipconfig /release"],
                output="Wireless LAN adapter Wi-Fi:\n\n   Connection-specific DNS Suffix  . :\n   Link-local IPv6 Address . . . . . : fe80::839:3d83:be2e:eb99%21\n   Default Gateway . . . . . . . . . :\n\n\nNotice the IPv4 address is gone.",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="W",
                levelNumber=3,
                exerciseNumber=3)
WL3E4 = Question("EX4. Type the command that will give a new IPv4 address of the default network adapter",
                ["ipconfig /renew"],
                output="Wireless LAN adapter Wi-Fi:\n\n   Connection-specific DNS Suffix  . : Work\n   Link-local IPv6 Address . . . . . : fe80::839:3d83:be2c:eb79%21\n   IPv4 Address. . . . . . . . . . . : 192.168.0.83\n   Subnet Mask . . . . . . . . . . . : 255.255.255.0\n   Default Gateway . . . . . . . . . : 192.168.0.1\n",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="W",
                levelNumber=3,
                exerciseNumber=4)
WL3E5 = Question("EX5. Run chkdsk for drive D:",
                ["chkdsk D:", "chkdsk d:"],
                output="The type of the file system is FAT32.\nShadow copying the specified volume is not supported.\n\nVolume boot created 2/13/2020 4:09 PM\nVolume Serial Number is 4BBD-D3E7\nWindows is verifying files and folders...\nFile and folder verification is complete.\n\nWindows has scanned the file system and found no problems.\nNo further action is required.\n\n  264,289,280 bytes total disk space.\n          512 bytes in 1 hidden files.\n       16,896 bytes in 3 folders.\n   54,727,680 bytes in 229 files.\n  209,541,120 bytes available on disk.\n\n          512 bytes in each allocation unit.\n      516,190 total allocation units on disk.\n      409,260 allocation units available on disk.\n\nThis gives you a detailed report about the drive and the\nscan it performed.",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="W",
                levelNumber=3,
                exerciseNumber=5)
WL3E6 = Question("EX6. Run a scan on drive C:",
                ...
                output="The type of the file system is NTFS.\nVolume label is Local Disk.\n\nStage 1: Examining basic file system structure ...\n  676096 file records processed.\nFile verification completed.\n Phase duration (File record verification): 11.60 seconds.\n  72 large file records processed.\n Phase duration (Orphan file record recovery): 0.00 milliseconds.\n  0 bad file records processed.\n Phase duration (Bad file record checking): 1.32 milliseconds.\n\nStage 2: Examining file name linkage ...\n  19539 reparse records processed.\n  784694 index entries processed.\nIndex verification completed.\n Phase duration (Index verification): 8.89 seconds.\n  0 unindexed files scanned.\n Phase duration (Orphan reconnection): 871.93 milliseconds.\n  0 unindexed files recovered to lost and found.\n Phase duration (Orphan recovery to lost and found): 1.63 milliseconds.\n  19539 reparse records processed.\n Phase duration (Reparse point and Object ID verification): 51.10 milliseconds.\n\nStage 3: Examining security descriptors ...\nSecurity descriptor verification completed.\n Phase duration (Security descriptor verification): 49.41 milliseconds.\n  54300 data files processed.\n Phase duration (Data attribute verification): 1.50 milliseconds.\nCHKDSK is verifying Usn Journal...\n  38472592 USN bytes processed.\nUsn Journal verification completed.\n Phase duration (USN journal verification): 246.16 milliseconds.\n\nWindows has scanned the file system and found no problems.\nNo further action is required.\n\n 498684927 KB total disk space.\n 219295400 KB in 407735 files.\n    161624 KB in 54301 indexes.\n         0 KB in bad sectors.\n   2804575 KB in use by the system.\n     42448 KB occupied by the log file.\n 276423328 KB available on disk.\n\n      4096 bytes in each allocation unit.\n 124671231 total allocation units on disk.\n  69105832 allocation units available on disk.\nTotal duration: 21.73 seconds (21733 ms).\n",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="W",
                levelNumber=3,
                exerciseNumber=6)
...
WQuiz1 = Quiz([
    ...
    Question("4. Which command will change the directory to the User's Documents folder?",
            ...
            ask_until_correct=False),
    Question("5. You can use cd .. to go to the parent directory",
            ["True"],
            ["True", "False"],
            ask_until_correct=False),
    Question("6. Windows and Linux use the same commands.",
            ["False"],
            ["True", "False"],
            ask_until_correct=False),
...
WQuiz2 = Quiz([
    ...
    Question("5. What utility is used to create a new file?",
            ...
            ask_until_correct=False),
    Question("6. What command shows you the contents of a file in the command line?",
            ["more"],
            ["/?", "more", "move", "show"],
            ask_until_correct=False),
    ...
    Question("9. more C:\\Users\\CLIME\\Pictures\\lineup.txt",
            ...
            ask_until_correct=False),
    Question("10. When using 'more', you must type the name of the file exactly as it is (including extension).",
...
WQuiz3 = Quiz([
    ...
    Question("3. What command is used to check the file system of a computer?",
            ...
            ask_until_correct=False),
    Question("4. What sequence of options releases the IP address of the computer and gives the computer a new IP?",
