...
LL1E2 = Question("Print out the list one entry per line.",
                ["ls -1"],
                output="clime@DESKTOP-5HPSK9S:~$ ls -1\nDesktop\nDocuments\nDownloads\nMusic\nTemplates\nVideos",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=2)
LL1E3 = Question("Change your directory to be in your Desktop folder (home folder if N/A)",
                ["cd Desktop"],
                output="clime@DESKTOP-5HPSK9S:~/Desktop$  ",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=3)
...
LL1E5 = Question("Print out your logical path.",
                ["pwd -L"],
                output="clime@DESKTOP-5HPSK9S:~$ pwd -L\n/home/clime",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=5)
LL1E6 = Question("Print out your physical path.",
                ["pwd -P"],
                output="clime@DESKTOP-5HPSK9S:~$ pwd -P\n/home/clime",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=6)
LL1E7 = Question("Print out your computer hostname ",
                ["uname -n"],
                output="clime@DESKTOP-5HPSK9S:~$ uname -n\nDESKTOP-5HPSK9S",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=7)
...
LL1E9 = Question("Enter the digits to give read, write, and excute permissions to the file clime.py",
                ["chmod 755 clime.py"],
                output="clime@DESKTOP-5HPSK9S:~/Documents$ chmod 755 clime.py\nclime@DESKTOP-5HPSK9S:~/Documents$",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=9)
LL1E10 = Question("Which option to sudo outputs the version?",
                ["sudo -V"],
                output="clime@DESKTOP-5HPSK9S:~$ sudo -V\nSudo version 1.8.31\nSudoers policy plugin version 1.8.31\nSudoers file grammar version 46\nSudoers I/O plugin version 1.8.31",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=1,
                exerciseNumber=10)
...
LL2E2 = Question("Move your temp.py file from one directory to Desktop.",
                ...
                output="clime@DESKTOP-5HPSK9S:~/Documents$ mv temp.py /home/clime/Desktop/\nclime@DESKTOP-5HPSK9S:~/Documents$",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=2,
                exerciseNumber=2)
LL2E3 = Question("Remove the temp.py file from your documents folder.",
                ["rm temp.py", ],
                output="clime@DESKTOP-5HPSK9S:~/Desktop$ rm temp.py\nclime@DESKTOP-5HPSK9S:~/Desktop$",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=2,
                exerciseNumber=3)
LL2E4 = Question("Try to remove the REMOVE directory from your terminal.",
                ["rmdir REMOVE"],
                output="clime@DESKTOP-5HPSK9S:~$ rmdir REMOVE/\nclime@DESKTOP-5HPSK9S:~$",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=2,
                exerciseNumber=4)
LL2E5 = Question("Make directory called CLIMe in your home directory ",
                ["mkdir CLIMe"],
                output="clime@DESKTOP-5HPSK9S:~$ mkdir CLIMe\nclime@DESKTOP-5HPSK9S:~$",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=2,
                exerciseNumber=5)
...
LL2E7 = Question("Remove the CLIMe directory that you created earlier.",
                ["rmdir CLIMe"],
                output="clime@DESKTOP-5HPSK9S:~$ rmdir CLIMe",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=2,
                exerciseNumber=7)
...
LL2E10 = Question("Etner the command to display all network interfaces.",
                ["ip link show"],
                output="clime@DESKTOP-5HPSK9S:~$ ip link show\n6: eth0: <> mtu 1500 group default qlen 1\n    link/ether bc:5f:f4:5a:76:28\n21: eth1: <> mtu 1500 group default qlen 1\n    link/ether 00:ff:ff:1a:15:d2\n1: lo: <LOOPBACK,UP> mtu 1500 group default qlen 1\n    link/loopback 00:00:00:00:00:00\n4: wifi0: <BROADCAST,MULTICAST,UP> mtu 1500 group default qlen 1\n    link/ieee802.11 00:0e:3b:76:08:ec\n20: wifi1: <> mtu 1500 group default qlen 1\n    link/ieee802.11 02:0e:3b:76:08:ec\n15: wifi2: <> mtu 1500 group default qlen 1\n    link/ieee802.11 00:0e:3b:76:08:ec\nclime@DESKTOP-5HPSK9S:~$",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=2,
                exerciseNumber=10)
...
LL3E2 = Question("Verify an archive file",
                ...
                output="tar -W [archive-file] [file or directory to be archived]",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=3,
                exerciseNumber=2)
LL3E3 = Question("Remove your zip from your archive (filename of file is ll3e3 HINT:look at the syntax and options).",
                ...
                output="$zip –d ll3e3.zip ll3e3.txt",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=3,
                exerciseNumber=3)
LL3E4 = Question("Update your zip file, (filename of file is ll3e4 HINT:look at the syntax and options).",
                ...
                output="$zip –u ll3e4.zip ll3e4.txt",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=3,
                exerciseNumber=4)
...
LL3E7 = Question("Enter the syntax to back up an entire harddisk (HINT: review difference between backing up and cloning).",
                ...
                output="# dd if = /dev/sda of = /dev/sdb",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=3,
                exerciseNumber=7)
LL3E8 = Question("Enter the syntax to backup a parition (Name of parition is parition.img)",
                ...
                output="# dd if=/dev/hda1 of=~/partition.img",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
                levelNumber=3,
                exerciseNumber=8)
...
WL1E2 = Question("Change your working directory to be in the Desktop folder",
                ...
                levelNumber=1,
                exerciseNumber=2)
WL1E3 = Question("From the Desktop folder, change you directory to the Documents folder (hint: you may have to type out the folder path starting with C:/",
                ...
                levelNumber=1,
                exerciseNumber=3)
WL1E4 = Question("What option would you enter if you wanted to know what options are available for the DIR command?",
                ["/?", "dir /?", "DIR /?, Dir /?"],
                ...
                levelNumber=1,
                exerciseNumber=4)
WL1E5 = Question("Write the command that prints out the directory structure graphically",
                ["tree", "test answer 2"],
                ...
                levelNumber=1,
                exerciseNumber=5)
WL1E6 = Question("Write the command that prints out the directory structure and all its containing files graphically",
                ["tree /F"],
