...
LL1E8 = Question("EX8.Print out your kernel version",
                ...
                levelNumber=1,
                exerciseNumber=8)
LL1E9 = Question("EX9.Enter the digits to give read, write, and excute permissions to the file clime.py",
                ["chmod 755 clime.py"],
                output="\nSUCCESSFULLY COMPLETED",
                feedback=lambda their_answer, correct: feedback2(their_answer, correct),
                platform="L",
...
LL3E6 = Question("EX6.How many users can a group have?",
                ...
                levelNumber=3,
                exerciseNumber=6)
LL3E7 = Question("EX7.Enter the syntax to back up an entire harddisk (HINT: review difference between backing up and cloning).",
